...
public class KeyMap {
    ...
    private static readonly KeyMap[] KeyMaps = {
        ...
        new() { KeyCommand = KeyCommand.KC_SEARCHCASE, Modifiers = ConsoleModifiers.Control, Key = ConsoleKey.F5 },
        ...
        new() { KeyCommand = KeyCommand.KC_REGEXP, Modifiers = ConsoleModifiers.Control, Key = ConsoleKey.F6 },
