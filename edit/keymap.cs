...
public class KeyMap {
    ...
    private static readonly KeyCommands[] CommandTable = {
        ...
        new() { CommandName = "compile_it", CommandId = KeyCommand.KC_COMPILE },
        ...
        new() { CommandName = "next_error", CommandId = KeyCommand.KC_NEXTERROR },
        ...
        new() { CommandName = "reform", CommandId = KeyCommand.KC_REFORM },
    ...
    private static readonly KeyMap[] KeyMaps = {
        ...
        new() { KeyCommand = KeyCommand.KC_NEXTERROR, Key = ConsoleKey.F3 },
        ...
        new() { KeyCommand = KeyCommand.KC_PREVBUFFER, Modifiers = ConsoleModifiers.Control, Key = ConsoleKey.P },
