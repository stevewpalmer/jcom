...
public static partial class Commands {
    ...
    /// <summary>
    /// RENAME command: renames a source file to a target file. The rename fails
    /// if the target file already exists.
    /// </summary>
    /// <param name="cmdLine">Command line</param>
    /// <returns>True if command succeeded, false if there were errors</returns>
    public static bool CmdRename(Parser cmdLine) {
        ...
        if (File.Exists(targetfile)) {
            Console.WriteLine(Shell.TargetAlreadyExists);
            return false;
        }
